...
import image from '../assets/moh.png'
import { 
    ...
    <div className='flex space-x-2 p-5'>
        ...
        <div className='flex flex-1 items-center pl-2'>
            <form className='flex flex-1 flex-col'>
                <input className='h-24 w-full text-xl outline-none 
                placeholder:text-xl' type="text" 
                ...
                <div className='flex items-center'>
                    ...
                    font-bold text-white rounded-full disabled:opacity-40'>Tweet</button>
                </div>
            </form>
        </div>
    </div>
